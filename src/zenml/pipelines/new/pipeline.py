...
class Pipeline:
    ...
    _ACTIVE_PIPELINE: ClassVar[Optional["Pipeline"]] = None
    ...
    def __init__(
        ...
        """
        # TODO: include settings, extra in __init__
    ...
    def __enter__(self):
        if Pipeline._ACTIVE_PIPELINE:
            raise RuntimeError("Active pipeline already exists.")

        Pipeline._ACTIVE_PIPELINE = self
        return self

    def __exit__(self, type, value, traceback):
        Pipeline._ACTIVE_PIPELINE = None
